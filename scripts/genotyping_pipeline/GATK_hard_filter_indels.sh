...
java -jar /global/home/users/davidtian/Genome_assembly_pipeline_scripts/GenomeAnalysisTK.jar \
    ...
    -V V /global/scratch/davidtian/joint_vcfs/all_desert_pupfish/final_variants/ADP_RawINDELS.vcf \
    --filterExpression "QD < 2.0 || FS > 200.0 || ReadPosRankSum < -20.0" \
    --filterName "GATK_indel_filter" \
    -o /global/scratch/davidtian/joint_vcfs/all_desert_pupfish/final_variants/ADP_gatk_hf_indels.vcf 
